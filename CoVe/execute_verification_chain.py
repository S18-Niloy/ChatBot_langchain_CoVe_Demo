...
class ExecuteVerificationChain(Chain):
    """
    Implement and execution of the verification question for factual acuracy
    """
    ...
    def _call(
        ...
        verification_answers_list = list() # answers of each verification questions
